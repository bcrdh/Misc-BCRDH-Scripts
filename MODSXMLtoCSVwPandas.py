...
col_names =  ['PID', 'ImageLink','Title', 'AlternativeTitle', 'Creator1_Given','Creator1_Family', 'Creator2_Given','Creator2_Family', 'Creator3_Given','Creator3_Family']
...
col_names += ['Genre','Type','internetMediaType','Language','Notes','AccessIdentifier','LocalIdentifier','uuid','ISBN','Classification','URI']
col_names += ['Source','Rights','CreativeCommons_URI','RightsStatement','relatedItem_1','relatedItem_2']

dirList = []
path = r"C:\\Users\Sharo\Desktop\frakkedUp"
...
for d in dirList:
    ...
    repCol = d[beg:]
    print(repCol)
    #print(str(len('C:\\Users\Sharo\Desktop\DOH_MODS_XML\')))
    ...
    #personal name subjects (can have up to 3)
        ...
        ui = soup.find('identifier',{'type':'uuid'})
        if ui != None:
            df.at[i, 'uuid'] = ui.getText().strip()
        ...
        #relatedItem
        #df.at[i, 'relatedItem_1'] = "Lumby Photographs"
        clcn = repCol
        df.at[i, 'relatedItem_2'] = clcn.replace("_",":")
        lastRepCol = repCol
        i = i + 1
